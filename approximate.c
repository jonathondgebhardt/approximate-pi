 ...
 *
 * Challenge:
 *   - The optimal value for P, where P is the number of points generated by
 *     each node
 */
...
int main(int argc, char *argv[])
{
    ...
    if (rank == 0)
    {
        ...
        // Show results.
        printf(
            "[%d] Approximation is %f after %d tries using %d "
            "workers\n",
            rank, approximation, iterations, (ncpu - 1));
        printf(
            "[%d] %d total inside points out of %d total points "
            "generated\n",
    ...
    else
    {
        ...
        while (1)
        {
            ...
            // Report amount of inside points generated to task
            // master.
...
/*
 * Generate a pair of points for the given amount of iterations. Return
 * the amount of points within the first quadrant of the unit circle.
 */
